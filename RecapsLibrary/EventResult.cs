...
namespace Recaps
{
    ...
    public class EventResults
    {
        ...
        public static CombatLogEntry ParseRow(string RawEvent, DateTime timeStamp)
        {
            ...
            {
                case "DAMAGE":
                    thisEntry.EventClassification = EventClassification.harm;
                ...
                case "MISSED":
                    ...
                    break;
                case "HEAL":
                    thisEntry.EventClassification = EventClassification.heal;
        ...
        public static SpellType SpellClassification(String spellName)
        {
